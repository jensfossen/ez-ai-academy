...
- Analogy cards: [`resources/context-engineering-analogies.md`](../resources/context-engineering-analogies.md) — binder, tabs, briefing folder, weather report, yesterday’s stock. Not in the Cowork ZIP; mentors use the in-lesson analogies there.

...
**Cursor IDE chat** is the reference surface. Prefer the host AskQuestion clarifying-question picker when the host attaches it (Plan Mode family), and in-chat video when the IDE can play a lesson link. Neither is a published skill-author API, and AskQuestion is not guaranteed in every Agent chat — details in [`RICH_UI.md`](RICH_UI.md). Do not invent private markup. If a native control is missing, use the Markdown numbered-list and link fallbacks.
...
Source: [Cursor — Agent Skills](https://cursor.com/docs/skills). Last verified 2026-09-09. IDE AskQuestion and in-chat-video research remains open on [#24](https://github.com/jensfossen/ez-ai-academy/issues/24).

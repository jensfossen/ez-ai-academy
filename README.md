...
| `ui/` | Interaction patterns with text fallbacks; [mobile / on-the-go principles](ui/mobile-on-the-go.md); [in-harness checklist + Show me](ui/in-harness-checklist.md); [Claude Code Learn competitive note](ui/competitive-learn-claude-code.md) |

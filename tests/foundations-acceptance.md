...
Phase A of [#30](https://github.com/jensfossen/ez-ai-academy/issues/30) documents synthetic learner fixtures in [`learner-personas.md`](learner-personas.md) and how to score a run in [`self-test-metrics.md`](self-test-metrics.md). Use those when driving this scenario as a scripted learner. They do not record a Pass. Do not treat a persona score as multi-harness validation or commercial readiness. Keep the result scale above.

...
Product brand is locked as **EZ AI Academy**. Guidelines: [`brand/BRAND.md`](../brand/BRAND.md).
...
`context_engineering` is an additive Module 3 id under `academy_version: "0.1"`. `agents_harness_engineering` is an additive Module 4 id under the same version. `loop_engineering` is an additive Module 5 id under the same version. Older exports without these keys remain valid — treat a missing key as `not_started`. Do not bump the schema version for these additive ids. Mentors emit each key when the learner starts or completes that module. Preserve unknown keys on restore.
...
| `current.module` | Module id the learner should continue (`foundations`, `prompt_engineering`, `context_engineering`, `agents_harness_engineering`, `loop_engineering`, or a later id). | Yes | No — implied by a `complete` module |
...
Example — Context Engineering complete, ready for Module 4 (additive `agents_harness_engineering` key):

```yaml
academy_version: "0.1"
current:
  module: "agents_harness_engineering"
  lesson: ""
modules:
  foundations:
    status: "complete"
  ...
  context_engineering:
    ...
    evidence:
      exercise:
        description: "Contained pack-and-result interaction at B or above"
        grade: "B"
        demonstrated_at: "2026-09-10"
      workplace_application:
        description: "Sanitized workplace pack application at B or above"
        grade: "B"
        demonstrated_at: "2026-09-10"
      reusable_artifact:
        description: "Context Working Card the learner can explain and update"
        demonstrated_at: "2026-09-10"
  agents_harness_engineering:
    status: "not_started"
    best_grade: null
  ...
  loop_engineering:
    ...
    evidence:
      ...
      workplace_application: null
      reusable_artifact: null
next_recommended_action: "Start Agents and Harness Engineering, or review Context Engineering if the learner asks."
```

Example — Agents and Harness Engineering complete, ready for Module 5 (additive `loop_engineering` key):

```yaml
academy_version: "0.1"
current:
  module: "loop_engineering"
  lesson: ""
modules:
  foundations:
    status: "complete"
  ...
  agents_harness_engineering:
    ...
    evidence:
      exercise:
        description: "Contained setup-and-result interaction at B or above"
        grade: "B"
        demonstrated_at: "2026-09-10"
      workplace_application:
        description: "Sanitized workplace harness application at B or above"
        grade: "B"
        demonstrated_at: "2026-09-10"
      reusable_artifact:
        description: "Harness Working Card the learner can explain and adapt"
        demonstrated_at: "2026-09-10"
  loop_engineering:
    status: "not_started"
    best_grade: null
    evidence:
      ...
      workplace_application: null
      reusable_artifact: null
next_recommended_action: "Start Loop Engineering, or review Agents and Harness Engineering if the learner asks."
```
...
- Agents and Harness Engineering scenario (ready to run, not a Pass): `tests/agents-harness-acceptance.md`
- Loop Engineering scenario (ready to run, not a Pass): `tests/loop-engineering-acceptance.md`

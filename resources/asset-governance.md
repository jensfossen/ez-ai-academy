...
1. Every factual key carries a **source note** (standards body, primary research, or official documentation). Module 1 Check A, Module 2 checks, Module 3 checks, and Module 4 checks already do this.
